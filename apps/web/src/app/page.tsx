...
function AudienceBenefitCard({
  ...
  return (
    <div className="page-surface flex flex-1 shrink-0 flex-col gap-9 rounded-4xl px-4 pt-9 pb-4 shadow-complex-6 shadow-gray-shadow">
...
export default function Home() {
  return (
    <>
      <PageSection variant="hero" pattern="dots">
        <div className="md:px-4 md:pt-4">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-8 md:gap-16">
            <div className="flex flex-col items-center justify-center gap-6 text-center">
              ...
              <p className="max-w-4xl text-balance">
                A proven graphene lubricant platform that will save diesel,
                extend oil life, increase vehicle availability, extend engine
                life and increase return on asset.
              </p>
      ...
      <PageSection variant="featured" pattern="hex">
        <div className="relative flex flex-col items-center gap-4 overflow-hidden px-4 pt-4 pb-10 md:mx-4 md:rounded-b-20">
      ...
      <PageSection variant="panel" className="py-4 md:py-8">
        <div className="page-surface mx-auto flex w-full max-w-6xl flex-col gap-8 rounded-20 px-6 py-10 md:flex-row md:py-16">
      ...
      <PageSection variant="band" pattern="grid">
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10 md:py-20">
          <div className="flex flex-col gap-4">
            <div className="flex w-fit items-center gap-1.5 rounded-10 bg-bg-white-0/80 py-1 pr-2.5 pl-2 ring-1 ring-stroke-soft-200">
          ...
          <div className="flex flex-col gap-6 md:flex-row">
            ...
            <div className="flex w-full flex-1 flex-col gap-6 pl-0 md:justify-between md:border-stroke-soft-200 md:border-l md:pl-6">
              <p className="text-paragraph-md text-text-sub-600">
                ...
                friction reduces inside your engines, you burn less fuel—and
                your maintenance team spends less time fighting wear on the
                assets that matter most.
                <br />
                <br />
                Simera Trace combines graphene expertise with an on-site
                benefits trial. We set it up with your people, measure against
                your baseline, and show what energy and maintenance savings look
                like in your real operating conditions.
                <br />
                <br />
                Results vary by load, equipment mix, and based on your data.
                That is why we validate on your mine—not with generic promises.
              </p>
              <div className="flex flex-col gap-4">
      ...
      <PageSection variant="panel" className="py-4 md:py-8">
        <div className="page-surface mx-auto flex max-w-6xl flex-col gap-8 rounded-20 px-2 py-10 md:flex-row md:px-4 md:py-16">
          <div className="flex w-full flex-col gap-6 px-4">
            ...
            <p className="text-pretty text-label-md text-text-soft-400">
              ...
              ultralubrication properties. In your engines it reduces friction
              by 50% and wear by 20-70% with Point of Seizure reduced by 30%, so
              you save energy and protect engines.
            </p>
            <div className="flex flex-col gap-4">
          ...
          <div className="flex w-full flex-col gap-2 md:w-[58%] md:shrink-0">
            <div className="page-surface-muted relative flex flex-col gap-6 overflow-hidden rounded-20 p-7">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-paragraph-md text-text-sub-600">
                  Microscopic graphene flakes plate onto metal surfaces inside
                  the engine—so parts slide against graphene, not bare metal.
                </p>
              </div>
            </div>
            <div className="page-surface-muted relative flex flex-col gap-6 overflow-hidden rounded-20 p-7">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-paragraph-md text-text-sub-600">
                  Friction creates hot spots. Graphene pulls heat into the oil
                  and block—protecting rings, liners, and bearings under load.
                </p>
              </div>
            </div>
            <div className="page-surface-muted relative flex flex-col gap-6 overflow-hidden rounded-20 p-7">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-paragraph-md text-text-sub-600">
                  ...
                  graphene stays on the metal—reducing scuffing until the full
                  oil film returns.
                </p>
              </div>
            </div>
            <div className="page-surface-muted relative flex flex-col gap-6 overflow-hidden rounded-20 p-7">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-paragraph-md text-text-sub-600">
                  Graphene platelets pack tightly into crevices, cavities,
                  scraes and asperities inside the engine, and fill them up.
                  This “reconditions” the engine from the inside out to reduce
                  blow by, and lengthen engine life.
                </p>
              </div>
            </div>
          </div>
      ...
      <PageSection variant="band" pattern="dots">
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10 md:flex-row md:py-20">
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-4">
              <div className="flex w-fit items-center gap-1.5 rounded-10 bg-bg-white-0/80 py-1 pr-2.5 pl-2 ring-1 ring-stroke-soft-200">
            ...
            <Accordion.Root type="single" collapsible className="space-y-2">
              <Accordion.Item value="a" className="page-surface ring-0">
                <Accordion.Trigger className="justify-start">
                  <Accordion.Arrow />
                  Who is the trial for?
                </Accordion.Trigger>
                <Accordion.Content>
                  Mining operations running diesel-powered equipment—haul
                  trucks, loaders, drills, and on-site power generation. If you
                  burn serious diesel, the trial is built for you.
                </Accordion.Content>
              </Accordion.Item>

              <Accordion.Item value="b" className="page-surface ring-0">
                <Accordion.Trigger className="justify-start">
                  <Accordion.Arrow />
                  How long does it take?
                </Accordion.Trigger>
                <Accordion.Content>
                  Most sites validate results in about 4-6 weeks. Setup is
                  quick; your fleet keeps operating while we measure against
                  your baseline.
                </Accordion.Content>
              </Accordion.Item>

              <Accordion.Item value="c" className="page-surface ring-0">
                <Accordion.Trigger className="justify-start">
                  <Accordion.Arrow />
                  Is it safe for our engines?
                </Accordion.Trigger>
                <Accordion.Content>
                  The lubricant is mixed into your existing engine oil at a
                  fixed ratio. It is designed for diesel and petrol combustion
                  engines. We recommend discussing OEM warranty status with your
          ...
          <div className="flex w-full flex-col gap-3 md:w-[58%] md:shrink-0">
            <div className="page-surface flex flex-col gap-1 rounded-[28px] p-1">
              ...
              <div className="flex flex-col gap-6 rounded-3xl bg-bg-weak-50 p-6">
            ...
            <div className="page-surface flex flex-col gap-6 rounded-3xl p-6">
              <div className="flex flex-col gap-5">
                <div className="flex flex-col gap-1">
                  <p className="text-label-md text-text-strong-950">
                    Not sure yet?
      ...
      <PageSection variant="panel" className="py-4 md:py-8">
        <div className="page-surface mx-auto flex max-w-6xl flex-col gap-8 rounded-20 px-6 py-10 md:py-16">
          <div className="flex flex-col gap-4">
            <div className="flex w-fit items-center gap-1.5 rounded-10 bg-bg-weak-50 py-1 pr-2.5 pl-2">
            ...
            <p className="text-label-md text-text-soft-400">
              Straight answers on graphene, the trial, and what results to
              expect— without the science lecture.
            </p>
          </div>
                ...
                <Accordion.Root type="single" collapsible className="space-y-2">
                  <Accordion.Item value="a" className="bg-bg-weak-50 ring-0">
                    ...
                    <Accordion.Content>
                      ...
                      expected per haul truck each year. There is also a
                      reduction in Particulate Matter (PM) and Unburned
                      Hydrocarbons (HC) which makes the mine safer. Reduced oil
                      waste and extended component life.
                    </Accordion.Content>
                  </Accordion.Item>
                  ...
                  <Accordion.Item value="a" className="bg-bg-weak-50 ring-0">
                    ...
                    <Accordion.Content>
                      Graphene is a single layer of carbon atoms—strong,
                      slippery, and excellent at conducting heat. In engine oil
                      it reduces friction where metal parts meet.
                    </Accordion.Content>
                  </Accordion.Item>
                  ...
                  <Accordion.Item value="c" className="bg-bg-weak-50 ring-0">
                    ...
                    <Accordion.Content>
                      ...
                      engine oil—diesel haul trucks, loaders, drills,
                      generators, and similar mine plant.
                    </Accordion.Content>
                  </Accordion.Item>
                </Accordion.Root>
              </div>
              <div className="flex flex-col gap-3">
                ...
                <Accordion.Root type="single" collapsible className="space-y-2">
                  <Accordion.Item value="a" className="bg-bg-weak-50 ring-0">
                    ...
                    <Accordion.Content>
                      No. The trial fits into your current lubrication
                      programme. Equipment keeps running while we measure fuel
                      use and wear indicators against your baseline.
                    </Accordion.Content>
                  </Accordion.Item>
              ...
              <div className="flex flex-col gap-3">
                ...
                <Accordion.Root type="single" collapsible className="space-y-2">
                  ...
                  <Accordion.Item value="b" className="bg-bg-weak-50 ring-0">
                    ...
                    <Accordion.Content>
                      That is why we trial on site. If the numbers do not stack
                      up for your operation, you have auditable data before any
                      wider rollout—no obligation to continue.
                    </Accordion.Content>
                  </Accordion.Item>
                  <Accordion.Item value="c" className="bg-bg-weak-50 ring-0">
                    <Accordion.Trigger className="justify-start">
                    ...
                    <Accordion.Content>
                      We compare fuel consumption and operating conditions
                      during the trial to your pre-trial baseline—using your
                      records and agreed metrics so finance and maintenance can
                      review the same dataset.
                    </Accordion.Content>
                  </Accordion.Item>
                  <Accordion.Item value="d" className="bg-bg-weak-50 ring-0">
                    ...
                    <Accordion.Content>
                      If savings justify rollout, we work with you on a
                      deployment plan aligned to your operation. If not, you
                      keep the validation data and we part ways with no hard
                      sell.
                    </Accordion.Content>
                  </Accordion.Item>
                </Accordion.Root>
      ...
      <PageSection variant="footer">
        <div className="relative mx-auto flex max-w-7xl flex-col gap-10 overflow-hidden px-6 py-10 md:gap-12 md:py-20">
